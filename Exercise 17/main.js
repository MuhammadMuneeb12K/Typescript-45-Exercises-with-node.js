...
while (guest_list.length > 2) {
    ...
    console.log("Sorry, ".concat(remove_guest, " I cannot invite you to dinner."));
}
console.log('Invitation to the last two guests');
guest_list.forEach(function (two_guest) { return console.log("Luckly ".concat(two_guest, ", you are still invited to the dinner.")); });
guest_list.pop();
guest_list.pop();
